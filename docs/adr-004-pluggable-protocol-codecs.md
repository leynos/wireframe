...
### Codec-aware test harness drivers (9.7.1)

The `wireframe_testing` crate now provides codec-aware driver functions that
accept any `FrameCodec` and handle frame encoding/decoding transparently:
